Vagrant.configure("2") do |config|
  ...
  nodes = [
    ["database", "192.168.56.11", "VM-Database-Esport"],
    ["backend", "192.168.56.10", "VM-Backend-Esport"],
    ["frontend", "192.168.56.12", "VM-Frontend-Esport"]
  ]
  ...
  nodes.each do |name, ip, vname|
    config.vm.define name do |machine|
      ...
      # Instalasi Ansible secara lokal di tiap node dan eksekusi playbook
